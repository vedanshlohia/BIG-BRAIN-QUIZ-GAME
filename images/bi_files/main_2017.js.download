...
function InitBtns()
{
	...
	strOut +=  '<div class="button download" id="ProxyBtn1" onclick="newwin(\'https://compressimage.toolur.com\');">	Compress Image</div>';
	strOut +=  '<div class="button download" id="ProxyBtn2" onclick="newwin(\'https://hnet.com/compress-jpeg\');">	Compress JPEG</div>';
	strOut +=  '<div class="button download" id="ProxyBtn3" onclick="newwin(\'https://hnet.com/webp-to-jpg\');">	Webp to JPG</div>';
	strOut +=  '<div class="button download" id="ProxyBtn4" onclick="newwin(\'https://pdftojpg.me\');">	PDF to JPG</div>';
	strOut +=  '<div class="button download" id="ProxyBtn5" onclick="newwin(\'https://hnet.com/heic-to-jpg\');">	HEIC to JPG</div>';
